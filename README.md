...
**Hello Rails React** This App is simple API, on how to write a Full-Stack Web application with Frontend React JS and Redux and Backend with Ruby on Rails.
...
Feel free to check the [issues page](https://github.com/Mike47ip/hello-world-one-app/issues).
